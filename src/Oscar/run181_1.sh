...
#CUDA_VISIBLE_DEVICES=5,6,7,8,9 python -m torch.distributed.launch --nproc_per_node=5 --master_port 10225 oscar/run_bag.py \
#CUDA_VISIBLE_DEVICES=0,1,2,3,4 python -m torch.distributed.launch --nproc_per_node=5 --master_port 10224 oscar/run_bag.py \

seed=42
for lr in {4e-5,5e-5}; do
